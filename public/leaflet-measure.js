    ...
    e.exports = `
      ...
      <div class="{{ model.className }}-interaction js-interaction">
        <div class="js-startprompt startprompt">
          <b style="font-size: 15px">Délimiter ou Mesurer les distances et les surfaces</b>
          <ul class="tasks"> <br>
            <a href="#" class="js-start start">Créer une nouvelle délimitation</a>
          </ul>
        </div>
        <div class="js-measuringprompt">
          <b style="font-size: 15px">Mesurer les distances et les surfaces</b>
          <p class="js-starthelp">
            Commencez à créer une mesure en ajoutant des points à la carte
          </p>
          <div class="js-results results"></div>
          <ul class="js-measuretasks tasks">
            <li><a href="#" class="js-cancel cancel">Annuler</a></li>
            <li>
              <a href="#" class="js-finish finish">Terminer</a>
            </li>
          </ul>
        </div>
      </div>`;
...
function (e, t, r) {
  e.exports = `
    <div class="group">
      <p class="lastpoint heading">Dernier point</p>
      <p>
    ...
    <div class="group">
      <p><span class="heading">Distance</span> {{ model.lengthDisplay }}</p>
    </div>
    <% } %> <% if (model.pointCount > 2) { %>
    <div class="group">
      <p><span class="heading">Zone</span> {{ model.areaDisplay }}</p>
    </div>
    <% } %>`;
},
function (e, t, r) {
  e.exports = `
    <b style="font-size: 15px">Emplacement du point</b>
    <p>
      {{ model.lastCoord.dms.y }} <span class="coorddivider">/</span> {{
      model.lastCoord.dms.x }}
    </p>
    <p>
      {{ numberFormat(model.lastCoord.dd.y, 6) }}
      <span class="coorddivider">/</span> {{ numberFormat(model.lastCoord.dd.x,
      6) }}
    </p>
    <ul class="tasks">
      <li><a href="#" class="js-zoomto zoomto">Centrer sur cet endroit</a></li>
      <li><a href="#" class="js-deletemarkup deletemarkup">Supprimer</a></li>
    </ul>`;
},
function (e, t, r) {
  e.exports = `
    <b style="font-size: 15px">Mesure linéaire</b>
    <p>{{ model.lengthDisplay }}</p>
    <ul class="tasks">
      <li><a href="#" class="js-zoomto zoomto">Centrer sur cette ligne</a></li>
      <li><a href="#" class="js-deletemarkup deletemarkup">Suprimer</a></li>
    </ul>`;
},
function (e, t, r) {
  e.exports = `
    <b style="font-size: 15px">Zone dessinée</b>
    <p>{{ model.areaDisplay }}</p>
    <p>{{ model.lengthDisplay }} Périmètre</p>
    <ul class="tasks">
    <li><a href="#" class="js-deletemarkup deletemarkup">Supprimer</a></li>
    <li><a href="#" class="js-save save">Sauvegarder</a></li>
    </ul>`;
    // <li><a href="#" class="js-zoomto zoomto">Centrer sur cette zone</a></li>
},
]);