<template>
  <q-card class="acteur1" v-if="!planModal && !updateModal && !planEditModal">
      ...
      <div class="q-gutter-xs">
        <q-card style="border-radius: 10px; background-color: #282828">
          <q-card-section class="text-white">
            ...
            <div class="q-mt-xs">
                <img src="Distance.png" style="height: 16px;"> <span class="q-ml-xs" v-if="itemsPlans.acteur.acteurPoly">{{itemsPlans.acteur.acteurPoly[0].superficie.toFixed(2)}} ha</span>
            </div>
...
export default defineComponent({
  ...
  setup (props) {
    ...
    console.log("itemsPlans.value", itemsPlans.value);
