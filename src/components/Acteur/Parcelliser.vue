<template>
  <q-card class="modal" v-if="!selectModal">
    ...
    <div class="q-ma-lg text-h6 text-center">Nouvelle parcellisation</div>
...
export default defineComponent({
  ...
  setup (props){
    ...
    onMounted( async() => {
      console.log("infoPere",props.infoPere);
    })
    ...
    let onSubmit = async () => {
      ...
      let idPere = JSON.parse(props.infoPere)
      submitting.value = true
      formData.value.pere = idPere.id
