<template>
  <q-card class="modal" v-if="!selectModal">
    ...
    <div class="q-ma-lg text-h6 text-center">Nouveau parcelle</div>
  ...
  <q-dialog position="bottom" v-model="selectModal">
...
export default defineComponent({
  ...
  setup (){
    ...
    console.log("user.enterprise.id ==>", user.enterprise.id);
