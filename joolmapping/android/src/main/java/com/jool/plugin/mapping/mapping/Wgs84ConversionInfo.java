...
public class Wgs84ConversionInfo
{
	...
	*/
	...
	{
		return String.format( "TOWGS84[%1$s, %2$s, %3$s, %4$s, %5$s, %6$s, %7$s]", Dx, Dy, Dz, Ex, Ey, Ez, Ppm);
	}
	...
	*/
	...
	{
		return String.format("<CS_WGS84ConversionInfo Dx=\"%1$s\" Dy=\"%2$s\" Dz=\"%3$s\" Ex=\"%4$s\" Ey=\"%5$s\" Ez=\"%6$s\" Ppm=\"%7$s\" />", Dx, Dy, Dz, Ex, Ey, Ez, Ppm);
	}
	...
	*/
	...
	{
		return this.equals(obj instanceof Wgs84ConversionInfo ? (Wgs84ConversionInfo)obj : null);
	}
