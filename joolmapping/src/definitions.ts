...
export type InfoCallback = (
  computationSettings: ComputationResult | null,
  err?: any,
) => void;

export type CheckListCallback = (
  checkListSettings: CheckListResult | null,
  err?: any,
) => void;

export type WatchPositionCallback = (
    position: CurrentDroneState | null,
    err?: any,
) => void;

export type MissionCallback = (
    missionSettings: CurrentMissionState | null,
    err?: any,
) => void;
