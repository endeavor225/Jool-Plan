...
public class Save {
    ...
    public static boolean saveString(String string, String key, Context mContext) {
        SharedPreferences prefs = mContext.getSharedPreferences(ConstantsRes.SAVE_PREFERENCE_NAME, 0);
...
//            System.out.println("reload index :" + i + " content:" + array2[i]);
    ...
    public static boolean removeArray(String arrayName, Context mContext) {
        SharedPreferences preferences = mContext.getSharedPreferences(ConstantsRes.SAVE_PREFERENCE_NAME, 0);
...
//            System.out.println("removeElement index :" + i + " " + list.get(i));
    ...
    public static void defaultSaveStringAsyn(@NonNull String key, @NonNull String value, @NonNull final Context context){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putString(key, value);
        editor.apply();
